...
help us fixing bugs in riccipy and check out the `"easy" tag`_. Those
should be easier to fix than the others and require less knowledge about the
library.

.. _`"easy" tag`: https://github.com/einsteinpy/riccipy/issues?q=is%3Aissue+is%3Aopen+label%3Aeasy
...
riccipy support - specifically, note that riccipy is a Python 3 only
library.
...
3. `Fork riccipy <https://help.github.com/articles/fork-a-repo/>`_.
4. `Clone your fork <https://help.github.com/articles/cloning-a-repository/>`_.
5. Install it in development mode using
   :code:`pip install --editable /path/to/riccipy/[dev]` (this means that the
